...
<!--				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/vtiger.png">-->
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group pie-bottom1">
							<button type="submit" class="button buttonBlue">Ingresar</button><br>
						</div>
					</form>
				...
				<div id="forgotPasswordDiv" class="hide">
					...
					<p style="color:#fff;">Por favor ingrese los detalle y envie<a class="forgotPasswordLink pull-right">Atras</a></p>
				</div>
			</div>
		</div>
